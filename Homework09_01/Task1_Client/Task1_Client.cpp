...
char** messServer = new char*[11]{ "001", "100", "101", "102", "110", "111", "112", "113", "200", "210", "211" };

char** MESSAGE = new char*[11]{
	"something wrong, please send again",
	"login successful",
	"already logined",
	"already logined in another client",
	"username is incorrect",
	"password is incorrect",
	"account is locked",
	"the account has just been locked because of incorrect login three times",
	"logout successful",
	"not logged in, so cannot log out",
